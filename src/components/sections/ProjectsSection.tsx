        ...
        {featuredProjects.map((project, index) => (
          ...
          >
            ...
            >
              <Card
                hoverable
                className="flex h-full flex-col overflow-hidden p-0 transition-all duration-300 hover:border-white/20"
              >
                {/* Image */}
                {project.imageUrl && (
                  <div className="relative h-56 w-full overflow-hidden border-b border-white/5 sm:h-64 lg:h-72">
                    <div className="absolute inset-0 z-10 bg-gradient-to-t from-background via-background/30 to-transparent mix-blend-multiply opacity-80 transition-opacity duration-500 group-hover:opacity-40" />
                    <Image
                    ...
                    <div
                      aria-hidden="true"
                      className="card-shine absolute inset-0 z-20 opacity-0 transition-opacity duration-500 group-hover:opacity-100"
                    />
                    {/* Badges */}
