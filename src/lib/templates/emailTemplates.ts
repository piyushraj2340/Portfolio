    ...
    <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f9f9f9; border-radius: 12px;">
      ...
      <div style="background-color: #ffffff; padding: 24px; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
        <div style="margin-bottom: 20px;">
          ...
          <p style="margin: 0; color: #111; font-size: 16px;"><strong>Name:</strong> ${name}</p>
          <p style="margin: 4px 0 0 0; color: #111; font-size: 16px;"><strong>Email:</strong> <a href="mailto:${email}" style="color: #3b82f6; text-decoration: none;">${email}</a></p>
        </div>
        ...
        <div>
          ...
          <div style="background-color: #f4f4f5; padding: 16px; border-radius: 6px; color: #333; line-height: 1.6; white-space: pre-wrap;">${message}</div>
        </div>
      </div>
