...
OG / social card: `public/og-images/og-mark.jpg` (2400×1254 JPEG, 1.91:1). After deploy, refresh LinkedIn with [Post Inspector](https://www.linkedin.com/post-inspector/). To regenerate: `npm run og:image`.
